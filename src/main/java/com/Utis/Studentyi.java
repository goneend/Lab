...
public class Studentyi implements java.io.Serializable {
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "studentyi")
    public List<Otsenki> getOtsenkis() {
        return this.otsenkis;
    }

    public void setOtsenkis(List<Otsenki> otsenkis) {
