...
public class Gruppyi implements java.io.Serializable {
    ...
    @Column(name = "KodSpets", nullable = false)
    public int getKodSpets() {
        return this.kodPlana;
    }

    public void setKodSpets(int kodPlana) {
        this.kodPlana = kodPlana;
    }
    ...
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "gruppyi")
